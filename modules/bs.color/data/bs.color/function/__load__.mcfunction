...
execute unless data storage bs:out color.int_to_rgba run data modify storage bs:out color.int_to_rgba set value [0,0,0,0]
execute unless data storage bs:out color.hex_to_rgba run data modify storage bs:out color.hex_to_rgba set value [0,0,0,0]
