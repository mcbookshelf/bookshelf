...
data modify storage bs.color: channel set value {r:0,g:0,b:0,a:0}
data modify storage bs.color: channel_h set value {r:"00",g:"00",b:"00",a:"00"}
data modify storage bs.color: rgb set value [0f,0f,0f,0f]
data modify storage bs.color: hex set value "#00000000"
data modify storage bs.color: int set value 0
