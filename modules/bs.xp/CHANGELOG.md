...
- ✨ Added `#bs.xp:add_progress` to fill the XP bar partially
- ✨ Added `#bs.xp:get_max_points` and `#bs.xp:get_remaining_points` to query the points of the current level
