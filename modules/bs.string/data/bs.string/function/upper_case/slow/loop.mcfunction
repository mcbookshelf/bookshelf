...
#
# Documentation of the feature: https://docs.mcbookshelf.dev/en/latest/modules/string.html#upper-case
# ------------------------------------------------------------------------------------------------------------

data remove storage bs:ctx _.lt
$data modify storage bs:ctx _.lt set from storage bs:data string.CharMap.Full[{l:"$(ch)"}].u
...
function bs.string:upper_case/fast/loop with storage bs:ctx _
