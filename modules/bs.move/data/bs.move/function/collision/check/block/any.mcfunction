...
execute if score #move.hit_flag bs.data matches 1.. unless data storage bs:lambda hitbox \
  run return run function bs.move:collision/check/block/cube with storage bs:ctx
