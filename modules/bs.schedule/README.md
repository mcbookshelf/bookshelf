...
- Cancel specific commands or clear all scheduled tasks
- Maintain execution context (entity & location) for scheduled commands
- Schedule commands with various time units (ticks, seconds, minutes, hours)
