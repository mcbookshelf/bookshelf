...
loot replace entity @s contents loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",modifier:[{type:"set_name",entity:"this",name:{storage:"bs:ctx",nbt:"_.left",interpret:true}}]}]}]}
...
loot replace entity @s contents loot {pools:[{rolls:1,entries:[{type:"item",name:"egg",modifier:[{type:"set_name",entity:"this",name:{storage:"bs:ctx",nbt:"_.right",interpret:true}}]}]}]}
