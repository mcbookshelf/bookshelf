...
execute if data storage bs:data animation[-1].step run return run function bs.animation:step/time/override
execute store result score #s bs.ctx run data get storage bs:data animation[-1].defs[0].step 1000
