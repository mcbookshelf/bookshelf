...
data modify storage bs:ctx _._ append value {f:"2d/linear",p:[0,0,0,0],t:0,d:0}
...
execute if data storage bs:ctx _.points[1] run function bs.animation:bake/2d/linear
