...
data modify storage bs:ctx _.points prepend value [0d,0d]
...
data modify storage bs:ctx _.points append value [0d,0d]
...
function bs.animation:bake/2d/catmull_rom
