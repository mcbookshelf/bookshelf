...
data modify storage bs:ctx _ merge from storage bs:ctx _.transformation.left_rotation
...
data modify storage bs:ctx _._.transformation.left_rotation set from storage bs:ctx _.s
