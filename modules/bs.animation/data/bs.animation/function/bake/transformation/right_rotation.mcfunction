...
data modify storage bs:ctx _ merge from storage bs:ctx _.transformation.right_rotation
...
data modify storage bs:ctx _._.transformation.right_rotation set from storage bs:ctx _.s
