...
data modify storage bs:ctx _ merge from storage bs:ctx _.transformation.translation
...
data modify storage bs:ctx _._.transformation.translation set from storage bs:ctx _.s
