...
execute if score #t bs.ctx >= #n bs.ctx run return run function bs.animation:utils/step/rotate/left
execute if score #t bs.ctx matches ..-1 run function bs.animation:utils/step/rotate/right
