...
execute store result score #n bs.ctx run data get storage bs:ctx _[0].d
execute store result score #x bs.ctx store result score #y bs.ctx store result score #z bs.ctx run scoreboard players operation #t bs.ctx /= #n bs.ctx
...
execute store result score #a bs.ctx run data get storage bs:ctx _[0].p[4] 1
execute store result score #b bs.ctx run data get storage bs:ctx _[0].p[5] 1
execute store result score #c bs.ctx run data get storage bs:ctx _[0].p[6] 1
...
execute store result score #a bs.ctx run data get storage bs:ctx _[0].p[8] 1
execute store result score #b bs.ctx run data get storage bs:ctx _[0].p[9] 1
execute store result score #c bs.ctx run data get storage bs:ctx _[0].p[10] 1
...
scoreboard players operation #z bs.ctx += #c bs.ctx
scoreboard players operation #z bs.ctx *= #t bs.ctx
scoreboard players operation #z bs.ctx /= -1000 bs.const
scoreboard players operation #z bs.ctx -= #b bs.ctx
scoreboard players operation #z bs.ctx *= #t bs.ctx
scoreboard players operation #z bs.ctx /= -1000 bs.const
scoreboard players operation #z bs.ctx += #a bs.ctx
