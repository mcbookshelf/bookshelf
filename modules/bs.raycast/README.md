...
- Use voxel traversal algorithm for accurate collision detection
- Detect collisions with both blocks and entities
- Execute commands at collision points
