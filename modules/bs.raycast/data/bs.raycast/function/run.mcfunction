...
data modify storage bs:data raycast.dm set from storage bs:data raycast.max_distance
...
data modify storage bs:data raycast merge value {tb:2147483647f,te:2147483647f,tm:2147483647f}
...
return run execute if predicate {type:"float_value_check",test:{max:2147483646},value:{type:"storage",storage:"bs:data",path:"raycast.tm"}}
