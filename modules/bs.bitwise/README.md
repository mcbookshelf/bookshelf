...
- **🔄 Operations**: perform bitwise AND, OR, XOR, and NOT operations on integers
- **🔢 Counting**: count the number of positive bits in an integer
- **📏 Length**: get the number of bits in an integer
