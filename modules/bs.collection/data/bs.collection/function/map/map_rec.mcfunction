...
function bs.collection:map/call with storage bs:data collection.stack[-1]
...
execute if data storage bs:data collection.stack[-1].value[0] run function bs.collection:map/map_rec
