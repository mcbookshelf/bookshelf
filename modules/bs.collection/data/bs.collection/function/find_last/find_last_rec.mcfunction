...
execute store success score #s bs.ctx run function bs.collection:find_last/call with storage bs:data collection.stack[-1]
...
execute if data storage bs:data collection.stack[-1].value[0] run function bs.collection:find_last/find_last_rec
