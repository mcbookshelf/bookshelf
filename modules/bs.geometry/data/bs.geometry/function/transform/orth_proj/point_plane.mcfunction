...
execute store result storage bs:out geometry.shape.origin[0] double 0.001 run scoreboard players operation #x bs.ctx -= #o bs.ctx
execute store result storage bs:out geometry.shape.origin[1] double 0.001 run scoreboard players operation #y bs.ctx -= #p bs.ctx
execute store result storage bs:out geometry.shape.origin[2] double 0.001 run scoreboard players operation #z bs.ctx -= #q bs.ctx
