...
data modify storage bs:ctx c set compute default float {\
    ...
    inputs:[\
        {\
            ...
            {type:"sub",left:{type:"storage",path:'geometry.shapes[{type:"point"}].origin[0]',storage:"bs:in"},right:{type:"storage",path:'geometry.shapes[{type:"plane"}].origin[0]',storage:"bs:in"}}\
            ]\
        },\
        {\
            type:"mul",\
            ...
            {type:"sub",left:{type:"storage",path:'geometry.shapes[{type:"point"}].origin[1]',storage:"bs:in"},right:{type:"storage",path:'geometry.shapes[{type:"plane"}].origin[1]',storage:"bs:in"}}\
            ]\
        },\
        {\
            type:"mul",\
            ...
            {type:"sub",left:{type:"storage",path:'geometry.shapes[{type:"point"}].origin[2]',storage:"bs:in"},right:{type:"storage",path:'geometry.shapes[{type:"plane"}].origin[2]',storage:"bs:in"}}\
            ]\
        }\
    ]\
}
