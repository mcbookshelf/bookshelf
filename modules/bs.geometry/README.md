...
- **📈  Line and Plane**: define intern line and plane with context's position and rotation of the functions call
- **📐  inPlane coord**: get line/plane intersection's inplane coords and distance to the origin of the line
