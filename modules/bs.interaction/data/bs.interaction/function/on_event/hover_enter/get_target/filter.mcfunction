...
execute store result score #s bs.ctx if predicate {type:"entity_properties",entity:"this",predicate:{"type_specific/player":{looking_at:{entity_type:"interaction",entity_tags:{all_of:["bs.interaction.mask"]},distance:{absolute:{max:24}}}}}}
