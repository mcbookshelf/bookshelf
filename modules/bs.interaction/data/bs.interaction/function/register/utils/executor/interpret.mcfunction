...
loot replace entity B5-0-0-0-3 contents loot {pools:[{rolls:1,entries:[{type:"item",name:"stone",modifier:[{type:"set_name",entity:"this",name:{"selector":"@n[tag=bs.interaction.this]"}}]}]}]}
