...
execute if predicate {type:"inverted",term:{type:"any_of",terms:[{type:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"}}},{type:"value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},range:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out","scale":-1}}}]}} \
