...
execute if predicate {type:"inverted",term:{type:"any_of",terms:[{type:"int_value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},test:{min:{type:"mul",inputs:[{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},-1]},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"}}},{type:"int_value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.1"},score:"bs.in"},test:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},max:{type:"mul",inputs:[{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},-1]}}}]}} \
  run scoreboard players operation $vector.normalize_max_component.factor bs.out = $vector.normalize_max_component.1 bs.in
execute if predicate {type:"inverted",term:{type:"any_of",terms:[{type:"int_value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.2"},score:"bs.in"},test:{min:{type:"mul",inputs:[{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},-1]},max:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"}}},{type:"int_value_check",value:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.2"},score:"bs.in"},test:{min:{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},max:{type:"mul",inputs:[{type:"score",target:{type:"fixed",name:"$vector.normalize_max_component.factor"},score:"bs.out"},-1]}}}]}} \
