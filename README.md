<h1 align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" alt="Bookshelf" srcset="docs/_imgs/banner-dark.png" width="400px">
    <img alt="Bookshelf" src="docs/_imgs/banner-light.png" width="400px">
  </picture>
</h1>
