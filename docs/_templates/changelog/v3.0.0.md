...
- <abbr title="Breaking Changes">⚠️</abbr> **[#282](https://github.com/mcbookshelf/Bookshelf/issues/282)** - Renamed scores used in the `on_collison` callback to use the new `bs.lambda` objective.
