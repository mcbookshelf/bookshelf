...
- <abbr title="New Bundles">📦</abbr> **[#323](https://github.com/mcbookshelf/Bookshelf/pull/323)** - Introduced four new bundles to replace the old Bookshelf and Bookshelf Dev datapacks: Bookshelf Essentials, Bookshelf Dev, Bookshelf Prefabs, and Bookshelf Suite.
